...
order_id = (SELECT o.id FROM orders o JOIN users u ON o.user_id = u.id WHERE email = "cieloblu@yahoo.com" ORDER BY o.created_at DESC LIMIT 1),
...
-- date di creazione casuali per utenti
UPDATE users
